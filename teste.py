...
class TelegramDownloaderApp(ctk.CTk):
    ...
    def ask_password(self):
        ...
        self.loop.call_soon_threadsafe(self.password_entered_event.set)
    ...
    async def send_code(self):
        ...
        try:
            ...
            self.code_entered_event.clear()
            self.after(0, self.ask_code)
            await self.code_entered_event.wait()
            ...
            self.password_entered_event.clear()
            self.after(0, self.ask_password)
            await self.password_entered_event.wait()
